...
public class NameParsingLink extends EntityParsingLink {
    public NameParsingLink(EntityParsingChain next) {
        super(next);
    }
...
class NameParsingLinkTest {
    @Test
    void construct_getsNormalName() throws IOException {
        NameParsingLink n = new NameParsingLink(null);
