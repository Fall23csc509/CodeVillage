...
{
    public ShapesRelativePositioningLink(ShapeChain next)
    {
        super(next);
    }
    ...
    public static void positionEntitiesInNeighborhoods(NeighborhoodWrapper wrapper)
    {
        ...
        // We will start by organizing all the entities into 'clusters' of classes that should be close
        // to each other.
        ...
        //
        // An additional constraint we will place is to make the biggest clusters be drawn on the far left
        ...
        // for simplicity's sake, lets make the rectangular layout of the entities always be a
        ...
        for(List<JavaEntity> clusterEntities : entityClusters)
        {
            ...
            aggregateClusterXShift +=
                    shapeSideLength * squareLayoutSideLength +
